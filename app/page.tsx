...
export default function Home(){
 ...
 function changeSpeed(value:number){const rate=normalizeSpeed(value);try{if(audio.current)applyPlaybackSpeed(audio.current,rate);setSpeed(rate);saveSpeedPreference(SPEED_KEY,rate);}catch{if(audio.current)applyPlaybackSpeed(audio.current,speed);setError('This browser does not support that playback speed. Choose a lower speed.');}}
