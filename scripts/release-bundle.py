...
files=['compose.prebuilt.yml','compose.prebuilt.cpu.yml','compose.prebuilt.nvidia.yml',
       'compose.ebooks.yml','compose.aio.cpu.yml','compose.aio.intel.yml','compose.aio.nvidia.yml',
       'setup.sh','doctor.sh','.env.example','LICENSE','README.md','docs/INSTALL.md',
       'docs/ALL_IN_ONE.md','docs/HTTPS.md','docs/STORYTELLER.md','docs/EBOOKS.md','docs/SECURITY_HARDENING.md','docs/HARDWARE.md','docs/UPGRADING.md','docs/USAGE.md','docs/DEVELOPMENT.md']
